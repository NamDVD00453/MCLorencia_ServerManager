                                    ...
                                    if ("youtube" === o.type) {
                                        ...
                                        (n.onload = function () {
                                            120 !== (this.naturalWidth || this.width) || i === e.length - 1
                                                ? ((o.videoImage = "https://img.youtube.com/vi/".concat(o.videoID, "/").concat(e[i], ".jpg")), t(o.videoImage))
                                                : (i++, (this.src = "https://img.youtube.com/vi/".concat(o.videoID, "/").concat(e[i], ".jpg")));
                                        }),
                                    ...
                                    : u.onAPIready(function () {
                                          ...
                                          if ((u.$video || ((e = document.createElement("div")).style.display = "none"), "youtube" === u.type)) {
                                              ...
                                              (u.playerOptions = {}),
                                                  ...
                                                  (u.playerOptions.playerVars = { autohide: 1, rel: 0, autoplay: 0, playsinline: 1 }),
                                                  ...
                                                  (u.playerOptions.events = {
                                                      onReady: function (t) {
                                                          if (
                                                              ...
                                                              u.options.endTime = u.player.getDuration() - 0.1;
                                                          }
                                                      ...
                                                      onStateChange: function (e) {
                                                          u.options.loop && e.data === YT.PlayerState.ENDED && u.play(u.options.startTime),
                                                              o || e.data !== YT.PlayerState.PLAYING || ((o = 1), u.fire("started", e)),
                                          ...
                                          if ("vimeo" === u.type) {
                                              if (
                                                  ((u.playerOptions = { id: u.videoID, autopause: 0, transparent: 0, autoplay: u.options.autoplay ? 1 : 0, loop: u.options.loop ? 1 : 0, muted: u.options.mute ? 1 : 0 }),
                                                  u.options.volume && (u.playerOptions.volume = u.options.volume),
                                                  u.options.showContols || ((u.playerOptions.badge = 0), (u.playerOptions.byline = 0), (u.playerOptions.portrait = 0), (u.playerOptions.title = 0)),
                                                  !u.$video)
                                              ) {
                                                  var r = "";
                ...
                t.prototype.coverImage = function () {
                    ...
                    if (t && e.video && o && ("IFRAME" === o || "VIDEO" === o)) {
                        var i = t.image.height,
                            ...
                            r = t.image.marginTop;
                        t.container.width > n && ((i = ((n = t.container.width) * e.image.height) / e.image.width), (a = 0), (r += (t.image.height - i) / 2)),
                            "IFRAME" === o && ((i += 400), (r -= 200)),
                            e.css(e.$video, { width: "".concat(n, "px"), marginLeft: "".concat(a, "px"), height: "".concat(i, "px"), marginTop: "".concat(r, "px") });
                    }
                    return t;
                };
                    ...
                    if (t.isValid())
                        if (e) {
                            if (
                                ...
                                return (
                                    (o.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"),
                                    "local" === t.type ||
                            ...
                            o.defaultInitImgResult ||
                                t.getImageURL(function (e) {
                                    ...
                                    t && o.$item.setAttribute("data-jarallax-original-styles", t), o.css(o.$item, { "background-image": 'url("'.concat(e, '")'), "background-position": "center", "background-size": "cover" });
                                });
                    return e;
                };
