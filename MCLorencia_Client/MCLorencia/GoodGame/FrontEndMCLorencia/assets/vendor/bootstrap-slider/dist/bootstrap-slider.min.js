        ...
        (function (a) {
            function e(b, c) {
                ...
                if (this.sliderElem) s = !0;
                    ...
                    if (
                        (z && this.options.labelledby[0] && p.setAttribute("aria-labelledby", this.options.labelledby[0]),
                        z && this.options.labelledby[1] && q.setAttribute("aria-labelledby", this.options.labelledby[1]),
                        !z && this.options.labelledby && (p.setAttribute("aria-labelledby", this.options.labelledby), q.setAttribute("aria-labelledby", this.options.labelledby)),
                        (this.ticks = []),
                ...
                if (
                    ...
                    Array.isArray(this.options.ticks) && this.options.ticks.length > 0 && (g || (this.options.max = Math.max.apply(Math, this.options.ticks)), f || (this.options.min = Math.min.apply(Math, this.options.ticks))),
            ...
            (d = function (a, b) {
                ...
                (d.prototype = {
                            ...
                            addMouseEnter: function (a, b, c) {
                                var d = function () {
                                    var d = a._copyState(),
                                        ...
                                        f = void 0;
                                    void 0 !== c ? ((e = a.options.ticks[c]), (f = (a.options.ticks_positions.length > 0 && a.options.ticks_positions[c]) || a._toPercentage(a.options.ticks[c]))) : (f = a._toPercentage(e)),
                                        (d.value[0] = e),
                                        (d.percentage[0] = f),
                    ...
                    _adjustPercentageForRangeSliders: function (a) {
                        if (this.options.range) {
                            ...
                            0 === this._state.dragged && this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
                                ...
                                : 1 === this._state.keyCtrl && this._toPercentage(this._state.value[0]) > a && ((this._state.percentage[1] = this._state.percentage[0]), (this._state.keyCtrl = 0), this.handle1.focus());
                        }
                    },
                    _mouseup: function (a) {
                        if (!this._state.enabled) return !1;
                    ...
                    _calculateValue: function (a) {
                        ...
                        return (
                            this.options.range
                                ? ((b.data = [this.options.min, this.options.max]), this._setValues(0, b), this._setValues(1, b), a && ((b.data[0] = this._snapToClosestTick(b.data[0])), (b.data[1] = this._snapToClosestTick(b.data[1]))))
                ...
                a &&
                    a.fn &&
                    (a.fn.slider ? (windowIsDefined && window.console.warn("bootstrap-slider.js - WARNING: $.fn.slider namespace is already bound. Use the $.fn.bootstrapSlider namespace instead."), (f = c)) : (a.bridget(b, d), (f = b)),
                    a.bridget(c, d),
                    a(function () {
