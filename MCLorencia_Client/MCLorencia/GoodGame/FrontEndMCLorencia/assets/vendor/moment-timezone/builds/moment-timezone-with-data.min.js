!(function (c, M) {
    ...
    function z(c) {
        var M = 0,
            ...
            a = 0,
            p = 1;
        for (45 === c.charCodeAt(0) && (p = -(M = 1)); M < o.length; M++) a = 60 * a + O(o.charCodeAt(M));
    ...
    function r(c) {
        ...
        return (
            ...
            { name: M[0], abbrs: q(M[1].split(" "), o), offsets: q(A, o), untils: z, population: 0 | M[5] }
        );
    }
    function N(c) {
        c && this._set(r(c));
    ...
    function u(c, M) {
        var A, o;
        for (L(M), A = 0; A < M.length; A++) (o = M[A]), (e[o] = e[o] || {}), (e[o][c] = !0);
    }
    function l() {
        try {
    ...
    return (
        "[object Array]" === Object.prototype.toString.call(k) ? (k.push("_z"), k.push("_a")) : k && (k._z = null),
        m({
            version: "2019c",
            zones: [
