        ...
        3: function (t, e, n) {
            ...
            var ft = {
                ...
                commonAncestor: function (t, e) {
                    for (var n = _(t), o = e; o; o = o.parentNode) if (n.indexOf(o) > -1) return o;
                    return null;
                },
                wrap: function (t, e) {
                    var n = t.parentNode,
                        ...
                        (n = [
                            {
                                ...
                                value: function () {
                                    ...
                                    return e.setEndPoint("EndToEnd", bt({ node: this.ec, offset: this.eo })), e;
                                },
                            },
                            {
                                key: "getPoints",
                                    ...
                                    var e = function (t, e) {
                                            ...
                                            if (
                                                ...
                                                (!ft.isEdgePoint(t) ||
                                                    ...
                                                    (ft.isRightEdgePoint(t) && e && ft.isVoid(t.node.nextSibling)) ||
                                                    (ft.isLeftEdgePoint(t) && !e && ft.isVoid(t.node.previousSibling)) ||
                                        ...
                                        ft.walkPoint(
                                            ...
                                            function (e) {
                                                ...
                                                ft.isEditable(e.node) ||
                                                    (o ? (ft.isLeftEdgePoint(e) && s.push(e.node), ft.isRightEdgePoint(e) && x.contains(s, e.node) && (i = e.node)) : (i = n ? ft.ancestor(e.node, t) : e.node), i && t(i) && a.push(i));
                                            },
                                            !0
                                        ),
                                        x.unique(a)
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e = this.sc === this.ec,
                                        n = this.getPoints();
                                    return (
                                        ft.isText(this.ec) && !ft.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
                                        ft.isText(this.sc) && !ft.isEdgePoint(this.getStartPoint()) && ((n.sc = this.sc.splitText(this.so)), (n.so = 0), e && ((n.ec = n.sc), (n.eo = this.eo - this.so))),
                ...
                kt = {
                    ...
                    createFromNode: function (t) {
                        var e = t,
                            ...
                            i = ft.nodeLength(o);
                        return (
                            ft.isVoid(e) && ((n = ft.listPrev(e).length - 1), (e = e.parentNode)),
                            ft.isBR(o) ? ((i = ft.listPrev(o).length - 1), (o = o.parentNode)) : ft.isVoid(o) && ((i = ft.listPrev(o).length), (o = o.parentNode)),
                            this.create(e, n, o, i)
                        );
                    },
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    ...
                                    r && (ft.appendChildNodes(a, x.from(r.childNodes)), ft.remove(r)),
                                    t
                                );
                            },
                        },
                            ...
                            value: function (t, e) {
                                for (
                                    var n = ft.ancestor(t.commonAncestor(), ft.isCell),
                                        ...
                                        a = i()("<tr" + r + "></tr>"),
                                        s = new Lt(n, Lt.where.Row, Lt.requestAction.Add, i()(o).closest("table")[0]).getActionList(),
                                        l = 0;
                                    l < s.length;
                                    l++
                                ) {
                                    ...
                                    switch (c.action) {
                                        ...
                                        case Lt.resultAction.SumSpanCount:
                                            if ("top" === e && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= o[0].rowIndex) {
                                                var d = i()("<div></div>")
                                                    .append(i()("<td" + u + ">" + ft.blank + "</td>").removeAttr("rowspan"))
                                                    .html();
                                                a.append(d);
                                                break;
                                            }
                            ...
                            value: function (t) {
                                for (
                                    var e = ft.ancestor(t.commonAncestor(), ft.isCell),
                                        ...
                                        r = n[0].rowIndex,
                                        a = new Lt(e, Lt.where.Row, Lt.requestAction.Delete, i()(n).closest("table")[0]).getActionList(),
                                        s = 0;
                                    s < a.length;
                                    s++
                                )
                            ...
                            value: function (t) {
                                for (
                                    var e = ft.ancestor(t.commonAncestor(), ft.isCell),
                                        n = i()(e).closest("tr"),
                                        o = n.children("td, th").index(i()(e)),
                                        r = new Lt(e, Lt.where.Column, Lt.requestAction.Delete, i()(n).closest("table")[0]).getActionList(),
                                        a = 0;
                                    a < r.length;
                                    a++
                                )
                    ...
                    (n = [
                            ...
                            value: function () {
                                ...
                                this.$editable
                                    .on("keydown", function (e) {
                                        if (
                                            (e.keyCode === Ct.code.ENTER && t.context.triggerEvent("enter", e),
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                return (
                                    (t = t || 0),
                                    (void 0 === e || !(Ct.isMove(e.keyCode) || Ct.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || x.contains([Ct.code.BACKSPACE, Ct.code.DELETE], e.keyCode))) &&
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = this;
                                if (
                                    (this.$codable.val(ft.html(this.$editable, this.options.prettifyHtml)),
                    ...
                    (n = [
                        {
                            ...
                            value: function (t) {
                                ...
                                return this.options.shortcuts && e
                                    ? (v.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")")
                                    : "";
                            },
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.context.memo("button.bold", function () {
                                    ...
                                    this.context.memo("button.fontsize", function () {
                                        return t.ui
                                            .buttonGroup([
                                                t.button({ className: "dropdown-toggle", contents: t.ui.dropdownButtonContents('<span class="note-current-fontsize"/>', t.options), tooltip: t.lang.font.size, data: { toggle: "dropdown" } }),
                                                t.ui.dropdownCheck({
                                ...
                                this.context.memo("button.justifyLeft", b.invoke(r, "render")),
                                    ...
                                    this.context.memo("button.fullscreen", function () {
                                        return t
                                            .button({ className: "btn-fullscreen", contents: t.ui.icon(t.options.icons.arrowsAlt), tooltip: t.lang.options.fullscreen, click: t.context.createInvokeHandler("fullscreen.toggle") })
                                            .render();
                                    }),
                            ...
                            value: function (t) {
                                ...
                                if (n && 11 === n[1].length) {
                                    ...
                                    e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                                        ...
                                        .attr("height", "310")
                                        .attr("width", "500")
                                        .attr("src", "https://v.qq.com/iframe/player.html?vid=" + w + "&amp;auto=0");
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                this.$popover.is(":visible") &&
                                    (t.keyCode === Ct.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === Ct.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === Ct.code.DOWN && (t.preventDefault(), this.moveDown()));
                            },
                        },
                        {
                            key: "searchKeyword",
